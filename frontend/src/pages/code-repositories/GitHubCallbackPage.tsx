          ...
          <div className="text-center">
            ...
            {status === "success" && (
              <>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  You have been successfully authenticated with GitHub. Redirecting to repository
                  selection...
                </p>
              </>
            )}
            ...
            {(status === "error" || saveRepositoryMutation.isError) && (
              <>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  {errorMessage || saveRepositoryMutation.error?.message}
                </p>
                <div className="mt-4 space-x-2">
                  ...
                  <Button onClick={() => navigate("/code-repositories")}>
