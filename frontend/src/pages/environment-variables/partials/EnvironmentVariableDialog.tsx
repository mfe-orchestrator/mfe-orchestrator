...
import useGlobalVariablesApi, {
  GlobalVariableCreateDTO,
} from "@/hooks/apiClients/useGlobalVariablesApi";
    ...
    <Dialog
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {isEditing
              ? t("environmentVariables.editVariable")
            ...
            {values &&
              values.map((envValue, index) => (
                <TextField
                  ...
                  label={
                    environments.find((e) => e._id === envValue.environmentId)?.name ||
                    envValue.environmentId
                  }
                />
              ))}
