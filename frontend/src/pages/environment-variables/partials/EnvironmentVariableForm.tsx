...
export function EnvironmentVariableForm({ initialData, environments, onSubmit, onCancel, isLoading = false }: EnvironmentVariableFormProps) {
        ...
        <FormProvider {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-4">
                    <h3 className="text-sm font-medium">{t("environmentVariables.form.environment_values")}</h3>
                    ...
                    {form.formState.errors.values && <p className="text-sm font-medium text-destructive">{form.formState.errors.values.message}</p>}
                </div>
