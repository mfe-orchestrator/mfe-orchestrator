...
function EnvironmentDialog({
  ...
  return (
    <Dialog
      open={isOpen}
      onOpenChange={form.formState.isSubmitting ? undefined : onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {id
              ? t("environment.page.form.edit_title", { name: formData.name })
              : t("environment.page.form.create_title")}
          </DialogTitle>
        </DialogHeader>
        <FormProvider {...form}>
          <form
