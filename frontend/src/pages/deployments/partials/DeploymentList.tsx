...
export const DeploymentList: React.FC<DeploymentListProps> = ({ environmentId }) => {
  ...
  const selectedDeployment = deployments.find(
    (deployment) => deployment._id === selectedDeploymentId,
  );
          ...
          {deployments.filter((deployment) => deployment.active) !== null && (
            <section className="mb-8">
              ...
              <div>
                <Accordion
                  type="single"
                  defaultValue={deployments.find((deployment) => deployment.active)?._id}
                  collapsible>
                  {deployments
                      ...
                      <AccordionItem value={deployment._id}>
                        ...
                        <AccordionContent>
                          ...
                          {deployment.variables.length > 0 && (
                            <div className="mt-4">
                              <h4 className="font-semibold text-primary mb-1">
                                {t("deployments.env_variables_title")}
                              </h4>
                              <ul>
                                {deployment.variables.map((variable) => (
                                  <li
                                    ...
                                    <div className="flex gap-1 items-start flex-wrap">
                                      ...
                                      <span className="hyphens-auto max-w-full">
                                        {variable.value}
                                      </span>
                                    </div>
                                  </li>
                          ...
                          <div className="mt-8">
                            <Button
                              variant="secondary"
                              href={`/deployments/${deployment._id}/canary-users`}>
                              <UsersRound />
