...
export function BuildDialog({ open, onOpenChange, microfrontendId, microfrontendName }: BuildDialogProps) {
    ...
    const branchesQuery = useQuery({
        ...
        queryFn: async () => {
            ...
            let name = mfe.codeRepository.name || mfe.codeRepository.repositoryId
            if (mfe.codeRepository.gitlab) {
                name = mfe.codeRepository.repositoryId
            }

            const branches = await getBranches(mfe.codeRepository.codeRepositoryId, name)
                ...
                <FormProvider {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <div className="space-y-2 mt-2 mb-4">
                            ...
                            <TextField name="version" label={t("microfrontend.build.version")} placeholder={t("microfrontend.build.versionPlaceholder")} />
                        </div>
                        <DialogFooter>
