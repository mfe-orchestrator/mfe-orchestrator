...
import {
  ...
  DangerZoneRemoveMicrofrontend,
} from "@/pages/microfrontends/partials/components";
...
const AddNewMicrofrontendForm: React.FC<AddNewMicrofrontendFormProps> = ({
            ...
            codeRepository: {
              ...
              codeRepositoryId:
                repositories.length === 1
                  ? repositories[0]._id
                  : repositories.find((repo) => repo.default)?._id,
            },
          }
        : {}),
      canary: {
  ...
  return (
    <SinglePageLayout
      ...
      description={
        isEdit ? t("microfrontend.edit_description") : t("microfrontend.add_new_description")
      }>
      <FormProvider {...form}>
        <form
...
const AddNewMicrofrontendPage: React.FC<AddNewMicrofrontendPageProps> = () => {
  ...
  return (
    <ApiStatusHandler queries={[storagesQuery, repositoriesQuery, versionsQuery, frontendQuery]}>
      <AddNewMicrofrontendForm
        storages={storagesQuery.data}
        repositories={repositoriesQuery.data}
        frontend={frontendQuery.data}
