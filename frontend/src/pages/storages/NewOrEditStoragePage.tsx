                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <Card>
                        <CardContent className="pt-6 space-y-6">
                            ...
                            <SelectField name="type" label={t("storage.type")} options={storageTypes} rules={{ required: t("validation.required") }} />

                            {renderAuthFields()}

                            <div className="flex justify-end space-x-4 pt-4">
                                <Button type="button" variant="secondary" onClick={() => navigate("/storages")}>
                                    {t("common.cancel")}
                                </Button>
