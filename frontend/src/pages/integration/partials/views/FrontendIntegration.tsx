import { Card, CardContent, CardHeader, Tabs, TabsContent, TabsList, TabsTrigger } from "@mfe-orchestrator/design-system"
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} tabsListPosition="fullWidth">
                        ...
                        <TabsContent value="vite">
                            ...
                            <pre className="bg-muted p-4 rounded-md overflow-x-auto text-sm">
                                <CodeIntegration framework="vite" microfrontendId={selectedMicrofrontend._id} deploymentId={activeDeployment._id} />
                            </pre>
                        </TabsContent>
                        ...
                        <TabsContent value="webpack">
                            ...
                            <pre className="bg-muted p-4 rounded-md overflow-x-auto text-sm">
                                <CodeIntegration framework="webpack" microfrontendId={selectedMicrofrontend._id} deploymentId={activeDeployment._id} />
                            </pre>
                        </TabsContent>
