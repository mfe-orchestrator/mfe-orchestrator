  ...
  return (
    <Dialog
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>
            {projects && projects.length > 1 ? t("project.switch") : t("project.create_new")}
          </DialogTitle>
        </DialogHeader>
        <div className="pt-4">
            ...
            <div className="mb-4 flex flex-col gap-2">
              {projects?.map((proj) => (
                <div
                  ...
                  className={cn(
                    `flex items-center px-3 py-2 rounded-md cursor-pointer border-2 border-transparent hover:border-accent/25`,
