...
## Corpus Check
- 448 files · ~443,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3777 nodes · 7593 edges · 210 communities (169 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26f8ace1`
...
- [[_COMMUNITY_telemetry.ts|telemetry.ts]]
...
- [[_COMMUNITY_TelemetryService|TelemetryService]]
...
2. `useToastNotificationStore` - 74 edges
3. `Button` - 68 edges
...
Cohesion: 0.07
Nodes (36): ColorPickerProps, TextareaFieldProps, EnvironmentSelectorProps, ApiStatusHandler(), useDeploymentsApi(), CreateEnvironmentDTO, EnvironmentDTO, useEnvironmentsApi() (+28 more)

### Community 4 - "Cloud Storage & Project Controllers"
Cohesion: 0.07
Nodes (22): organizationController(), Organization, organizationSchema, IOrganizationWithRole, OrganizationCreateInput, OrganizationSummaryDTO, OrganizationUpdateInput, aUser() (+14 more)

### Community 5 - "UI Cards & Alerts"
Cohesion: 0.10
Nodes (22): serveController(), federationName(), buildMicrofrontendAdaptedToServe(), CodeIntegrationRequestDTO, escapeRegExp(), GetAllDataDTO, GetMicrofrontendAdaptedDataDTO, getMicrofrontendUrlCanary() (+14 more)

### Community 6 - "Biome Configuration"
Cohesion: 0.08
Nodes (21): StartupController(), UserController(), ErrorDetails, ALLOWED_AVATAR_MIME_TYPES, IUserAvatar, IUserAvatarDocument, UserAvatar, userAvatarSchema (+13 more)
...
Cohesion: 0.09
Nodes (29): ProjectPickerListProps, AddUserToProjectDTO, Project, ProjectSummaryDTO, ProjectUpdateDTO, RoleInProject, useProjectApi(), useProjectUserApi() (+21 more)
...
Cohesion: 0.33
Nodes (6): customSource, customUrl, mfeOrchestratorHub, microfrontend, host, hostTypes
...
Cohesion: 0.09
Nodes (25): createOrganizationViaUi(), expectLoginPage(), isAuthenticated(), loginViaUi(), marketingOptInEnabled(), submitLoginForm(), waitForAuthenticated(), USER (+17 more)
...
Cohesion: 0.24
Nodes (13): apiKeyController(), codeRepositoryController(), environmentController(), globalVariablesController(), integrationController(), marketController(), microfrontendController(), microfrontendDependencyController() (+5 more)

### Community 17 - "UI Inputs & Popover"
Cohesion: 0.05
Nodes (53): AcceptInvitationDTO, AddUserToOrganizationDTO, organizationUserController(), UpdateUserRoleDTO, AcceptInvitationDTO, AddUserToProjectDTO, PopulatedProject, UpdateUserRoleDTO (+45 more)
...
Cohesion: 0.41
Nodes (12): activateAccountFromEmail(), AppSession, createProjectViaApi(), emailDeliveryUnavailable(), inviteCollaboratorViaUi(), loginViaApi(), newTestUser(), openApp() (+4 more)
...
Cohesion: 0.07
Nodes (35): DeploymentDTO, GlobalVariable, FederationFileChange, FederationIntegrationApplyResult, FederationIntegrationPlan, FederationIntegrationStatus, IntegrationScope, MicrofrontendIntegrationPlan (+27 more)
...
Cohesion: 0.14
Nodes (21): acceptOrganizationInvitationIfPending(), canSendEmail(), CreatedOrganization, CreatedProject, createOrganizationViaApi(), ensureOrganizationViaApi(), getAvatarViaApi(), getMineOrganizationsViaApi() (+13 more)
...
Cohesion: 0.12
Nodes (7): CodeRepository, ICodeRepository, CodeRepositoryService, retypedSecret(), CreateAzureDevOpsRepositoryDTO, CreateGitlabRepositoryDto, runInTransaction()

### Community 32 - "Login & Social Buttons"
Cohesion: 0.04
Nodes (69): GitHub Code Repository Provider, GitHub Logo (Octocat Mark), TextFieldProps, AddRepositoryAzureDTO, AddRepositoryGithubDTO, AddRepositoryGitlabDTO, AzureDevOpsProject, AzureDevOpsProjectsResponse (+61 more)
...
Cohesion: 0.19
Nodes (15): UserButton(), User, PROFILE_AVATAR_QUERY_KEY, useProfilePicture(), ALLOWED_MIME_TYPES, AvatarSection(), AvatarSectionProps, MarketingConsentSection() (+7 more)
...
Cohesion: 0.09
Nodes (31): EntityPickerLabels, EntityPickerList(), EntityPickerListProps, PickableEntity, BuildRun, BuildStatus, BuildStatusEnvironment, BuildUnavailableReason (+23 more)
...
Cohesion: 0.06
Nodes (44): CanaryDeploymentType, CanaryType, DimensionsDTO, HostedOn, Microfrontend, PositionDTO, RelationDTO, DeploymentMicrofrontendCardProps (+36 more)
...
Cohesion: 0.19
Nodes (9): FederationRemote, FederationIntegrationService, ManifestSnapshot, RepositoryTarget, DetectedStack, globalVariablesScriptTag(), globalVariablesScriptUrl(), injectGlobalVariablesScript() (+1 more)
...
Cohesion: 0.07
Nodes (40): CanaryDeploymentType, CanaryType, ICanaryMicrofrontend, IMicrofrontendStack, IPosition, Microfrontend, microfrontendCanaryTypeSchema, microfrontendCodeRepositorySchema (+32 more)
...
Cohesion: 0.10
Nodes (14): projectUserController(), createBusinessException(), IOrganization, IProject, IUserOrganization, UserOrganization, IUserProject, UserProject (+6 more)
...
Cohesion: 0.21
Nodes (9): AcceptInvitationDTO, AcceptInvitationResponse, InvitationInfo, OrganizationInvitationInfo, useInvitationApi(), FormValues, OrganizationInvitation(), FormValues (+1 more)
...
Cohesion: 0.10
Nodes (23): SinglePageHeaderProps, SinglePageLayout(), DeleteConfirmationDialog(), DeleteConfirmationDialogProps, CanaryUser, useCanaryUsersApi(), AzureAuthConfig, AzureStorageConfig (+15 more)

### Community 81 - "telemetry.ts"
Cohesion: 0.14
Nodes (17): telemetryController(), configSchema, Configuration, IConfiguration, logTelemetryNotice(), TelemetryService, TelemetryRuntimeConfiguration, TelemetryDecisionDTO (+9 more)
...
Cohesion: 0.10
Nodes (20): Button, PageHead(), PageHeadProps, GitHubCallbackPage(), AddRepositoryDialog(), AddRepositoryDialogProps, RepositoryProvider, NewProjectWizard() (+12 more)

### Community 87 - "Sidebar.tsx"
Cohesion: 0.11
Nodes (22): App(), queryClient, CalendarField(), CalendarFieldProps, LanguageSelector(), LanguageSelectorProps, ThemeToggle(), ThemeToggleProps (+14 more)
...
Cohesion: 0.09
Nodes (26): openInvitationFromEmail(), decodeHtmlEntities(), EmailMessage, extractLinks(), fetchInbox(), fetchTestmail(), getMessageLinks(), inboxAddress() (+18 more)
...
### Community 126 - "TelemetryService"
Cohesion: 0.38
Nodes (9): ApiKey, authHeaders(), createEnvironmentViaApi(), Environment, getApiKeysViaApi(), getEnvironmentsViaApi(), getStoragesViaApi(), json() (+1 more)
...
Cohesion: 0.09
Nodes (28): AzureDevOpsBuild, GithubWorkflowRun, buildController(), openEventStream(), sendEvent(), sleep(), getByProjectId, snapshot (+20 more)
...
Cohesion: 0.10
Nodes (19): app, error, name, page_title, back_home, generic, not_found, not_found_description (+11 more)
...
Cohesion: 0.09
Nodes (14): projectController(), EntityNotFoundError, EnvironmentNotFoundError, OrganizationNotFoundError, ProjectNotFoundError, Environment, environmentSchema, IWizardProjectState (+6 more)
...
Cohesion: 0.18
Nodes (11): subtitle, title, projectDeleted, projectUpdated, projectUpdateFailed, settings, account, dangerZone (+3 more)

### Community 181 - "projectInfo"
Cohesion: 0.22
Nodes (9): description, id, name, nameMinLength, nameRequired, slug, slugHint, title (+1 more)
...
Cohesion: 0.14
Nodes (14): delete, delete, button, confirmation, description, dialog, title, confirmation (+6 more)
...
Cohesion: 0.13
Nodes (10): Deployment, deploymentSchema, IDeployment, STORAGE_SECRET_PATHS, DeploymentService, encryptStoredSecrets(), LEGACY_CANARY_TYPES, migrateLegacyCanaryTypes() (+2 more)

### Community 194 - "GitlabClient.ts"
Cohesion: 0.10
Nodes (22): azureDataSchema, CODE_REPOSITORY_SECRET_PATHS, CodeRepositoryProvider, codeRepositorySchema, CodeRepositoryType, githubDataSchema, gitlabDataSchema, IAzureData (+14 more)
...
### Community 198 - "[3.1.0] - 2026-08-16"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (14): AuthTokenDataDTO, CustomError, EnvironmentHeaderNotFoundError, InvalidCredentialsError, ProjectHeaderNotFoundError, UserAlreadyExistsError, UserCannotAccessThisDeploymentError, UserCannotAccessThisEnvironmentError (+6 more)
...
Cohesion: 0.15
Nodes (13): subtitle, title, email, emailNotEditable, name, subtitle, surname, title (+5 more)
...
## Knowledge Gaps
- **1812 isolated node(s):** `description`, `main`, `start`, `st`, `dev` (+1807 more)
...
- **Why does `useUserApi()` connect `Backend Controller Layer` to `Login & Social Buttons`, `Dropdown Menu & Sidebar`, `GitHub Client Methods`, `Biome Configuration`, `Azure DevOps Client Types`, `Local Installation for development 🛠️`, `Telemetry Service & Config`, `Sidebar.tsx`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `toObjectId()` connect `MicrofrontendService.ts` to `Deployment Service & Models`, `Cloud Storage & Project Controllers`, `UI Cards & Alerts`, `Biome Configuration`, `[2.3.0] - 2026-08-11`, `UI Inputs & Popover`, `Tables & Layout Components`, `Sidebar & Theme Toggle`, `Code Repository Service`, `Google & S3 Storage Clients`, `AuthenticationMethod.ts`, `Canary Users Domain`, `EmailSenderService`, `User & Invitation API`, `Project Wizard Service`, `BaseAuthorizedService`, `DeploymentService`, `GitlabClient.ts`, `AuthenticationMethod.ts`, `EmailSenderService`, `GoogleStorageClient`, `IMarket`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `useApiClient()` connect `GitHub Client Methods` to `Login & Social Buttons`, `Backend Error Types`, `errorHandler.ts`, `Azure Storage & Microfrontend Model`, `theme`, `Auth Pages & Form Inputs`, `scripts`, `Azure DevOps Client Types`, `Form Input Fields`, `Local Installation for development 🛠️`, `BusinessException`, `Telemetry Service & Config`, `Backend Controller Layer`, `Sidebar.tsx`, `useUserApi.ts`, `Tabs Component`?**
