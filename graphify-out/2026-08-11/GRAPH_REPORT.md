...
## Corpus Check
- 377 files · ~323,099 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3326 nodes · 6090 edges · 202 communities (153 shown, 49 thin omitted)
...
Cohesion: 0.07
Nodes (11): IEnvironment, IGlobalVariable, GlobalVariablesService, GetAllDataDTO, getMicrofrontendUrlCanary(), hashToBucket(), ServeService, EnvironmentValue (+3 more)
...
Cohesion: 0.12
Nodes (19): PENDING_INVITATIONS_QUERY_KEY, PendingInvitationsList(), PendingInvitationsListProps, usePendingInvitationsQuery(), ProjectPickerList(), SinglePageHeaderProps, SinglePageLayout(), AcceptInvitationDTO (+11 more)

### Community 3 - "Backend Error Types"
Cohesion: 0.08
Nodes (32): TextareaFieldProps, EnvironmentSelectorProps, CreateEnvironmentDTO, EnvironmentDTO, useEnvironmentsApi(), EnvironmentValue, GlobalVariable, GlobalVariableCreateDTO (+24 more)
...
Cohesion: 0.12
Nodes (17): ApiStatusHandler(), CanaryUser, useCanaryUsersApi(), CanaryUser, DeploymentDTO, useDeploymentsApi(), CanaryUsers(), Deployments() (+9 more)
...
Cohesion: 0.10
Nodes (26): AcceptInvitationDTO, AddUserToProjectDTO, PopulatedProject, UpdateUserRoleDTO, UserProjectWithProject, AuthTokenDataDTO, fastify, configSchema (+18 more)
...
Cohesion: 0.07
Nodes (44): CanaryDeploymentType, CanaryType, DimensionsDTO, HostedOn, Microfrontend, PositionDTO, RelationDTO, useMicrofrontendsApi() (+36 more)
...
Cohesion: 0.14
Nodes (9): projectUserController(), createBusinessException(), IUserProject, UserProject, EnvironmentService, ProjectService, UserProjectService, EnvironmentDTO (+1 more)
...
Cohesion: 0.09
Nodes (27): FederationFileChange, FederationIntegrationApplyResult, FederationIntegrationPlan, FederationIntegrationStatus, MicrofrontendIntegrationPlan, MicrofrontendIntegrationResult, useIntegrationApi(), ICodeIntegrationDTO (+19 more)

### Community 28 - "API Key Domain"
Cohesion: 0.06
Nodes (47): AuthenticationType, createUrl(), doRequest(), getUTMFields(), IClientRequestData, IClientRequestMetadata, IUTMFields, out (+39 more)
...
Cohesion: 0.05
Nodes (46): GitHub Code Repository Provider, GitHub Logo (Octocat Mark), TextFieldProps, DeleteConfirmationDialog(), DeleteConfirmationDialogProps, AddRepositoryAzureDTO, AddRepositoryGithubDTO, AddRepositoryGitlabDTO (+38 more)
...
Cohesion: 0.21
Nodes (9): AuthenticationError, getSecret(), AuthUserDTO, getDataFromAuth0(), getDataFromGoogle(), getDataFromLocal(), getDataFromMsal(), getUserDataFromToken() (+1 more)
...
Cohesion: 0.20
Nodes (4): adm-zip, IMarket, CodeManagementService, MarketService
...
Cohesion: 0.04
Nodes (66): CanaryDeploymentType, CanaryType, HostedOn, ICanaryMicrofrontend, IMicrofrontendStack, IPosition, microfrontendCanaryTypeSchema, microfrontendCodeRepositorySchema (+58 more)
...
Cohesion: 0.09
Nodes (27): AuthConfig, AzureStorageConfig, AuthConfig, GoogleStorageConfig, S3ClientConfig, EntityNotFoundError, BuiltFrontend, builtFrontendSchema (+19 more)
...
Cohesion: 0.06
Nodes (50): App(), queryClient, AuthenticationLayout(), AuthenticationLayoutProps, sizeClasses, FormValues, LoginPage(), CalendarField() (+42 more)
...
Cohesion: 0.18
Nodes (11): codeRepositoryController(), ICodeRepositoryMicrofrontend, IHostMicrofrontend, CodeRepositoryImportService, FailedRepositoryResult, ImportableRepository, ImportedRepositoryResult, ImportRepositoriesResult (+3 more)
...
Cohesion: 0.08
Nodes (31): ApiKey, CreateApiKeyDTO, CreateApiKeyResponseDTO, useApiKeysApi(), AzureAuthConfig, AzureStorageConfig, CreateStorageDTO, GoogleAuthConfig (+23 more)

### Community 81 - "FastifyInstance"
Cohesion: 0.06
Nodes (29): apiKeyController(), authorizationController(), deploymentController(), environmentController(), globalVariablesController(), integrationController(), microfrontendController(), microfrontendDependencyController() (+21 more)
...
Cohesion: 0.07
Nodes (36): Button(), ProjectPickerListProps, SwitchProjectButton(), AddUserToProjectDTO, Project, ProjectSummaryDTO, useProjectApi(), NewProjectWizardProps (+28 more)
...
- **Why does `useUserApi()` connect `useUserApi.ts` to `BusinessException`, `Cloud Storage & Project Controllers`, `API Key Domain`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `toObjectId()` connect `Auth Wrappers & Context` to `Deployment Service & Models`, `Google & S3 Storage Clients`, `GitHub Client Methods`, `AuthenticationMethod.ts`, `UI Cards & Alerts`, `Cloud Storage & Project Controllers`, `DeploymentCanaryUsersController.ts`, `Microfrontend Pages & API`, `Canary Users Domain`, `UI Inputs & Popover`, `User & Invitation API`, `Backend Controller Layer`, `Tables & Layout Components`, `Error Handler Middleware`, `errorHandler.ts`, `API Hooks & Pages`, `Code Repository Service`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `useApiClient()` connect `BusinessException` to `Login & Social Buttons`, `Backend Controllers & Auth`, `Backend Error Types`, `Azure Storage & Microfrontend Model`, `Auth Pages & Form Inputs`, `toObjectId`, `API Key Domain`, `Dependencies.tsx`, `Sidebar & Theme Toggle`, `useUserApi.ts`, `Tabs Component`, `Multipart Plugin`?**
