...
## Corpus Check
- 399 files · ~333,919 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3459 nodes · 6458 edges · 206 communities (160 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2de536a4`
...
Cohesion: 0.12
Nodes (4): IEnvironment, IMicrofrontend, hashToBucket(), ServeService
...
Cohesion: 0.11
Nodes (19): AcceptInvitationDTO, AddUserToProjectDTO, PopulatedProject, projectUserController(), UpdateUserRoleDTO, UserProjectWithProject, EntityNotFoundError, EnvironmentNotFoundError (+11 more)

### Community 3 - "Backend Error Types"
Cohesion: 0.05
Nodes (46): ColorPickerProps, EnvironmentSelectorProps, PageHead(), PageHeadProps, ProjectPickerList(), SinglePageHeaderProps, SinglePageLayout(), CreateEnvironmentDTO (+38 more)

### Community 4 - "Cloud Storage & Project Controllers"
Cohesion: 0.11
Nodes (17): configSchema, Configuration, IConfiguration, Deployment, deploymentSchema, Environment, environmentSchema, GlobalVariable (+9 more)
...
Cohesion: 0.15
Nodes (15): CanaryDeploymentType, CanaryType, HostedOn, ICanaryMicrofrontend, IHostMicrofrontend, IPosition, microfrontendCanaryTypeSchema, microfrontendCodeRepositorySchema (+7 more)

### Community 8 - "Auth Pages & Form Inputs"
Cohesion: 0.13
Nodes (23): ApiStatusHandler(), useBuildsApi(), useBuildStatusStream(), CanaryUser, useCanaryUsersApi(), CodeRepositoryProvider, CanaryUser, useDeploymentsApi() (+15 more)
...
Cohesion: 0.11
Nodes (20): serveController(), federationName(), buildMicrofrontendAdaptedToServe(), CodeIntegrationRequestDTO, escapeRegExp(), GetMicrofrontendAdaptedDataDTO, getMicrofrontendUrlCanary(), getMicrofrontendUrlStatic() (+12 more)

### Community 17 - "UI Inputs & Popover"
Cohesion: 0.17
Nodes (8): createBusinessException(), IProject, IUserProject, UserProject, ProjectService, ProjectSummaryDTO, UserProjectService, recordLogin()

### Community 18 - "Frontend Routes"
Cohesion: 0.05
Nodes (30): Sidebar, AccountActivation, AddAzure, AddGithub, AddGitlab, AddMicrofrontend, AddStorage, ApiKeys (+22 more)
...
Cohesion: 0.12
Nodes (7): BusinessException, ErrorDetails, AxiosError, CustomError, ProjectCreateInput, ProjectUpdateInput, NewProjectWizardContext
...
Cohesion: 0.12
Nodes (4): RepositoryData, ICodeRepository, CodeRepositoryService, UpdateGithubDTO

### Community 32 - "Login & Social Buttons"
Cohesion: 0.05
Nodes (60): GitHub Code Repository Provider, GitHub Logo (Octocat Mark), AddRepositoryAzureDTO, AddRepositoryGithubDTO, AddRepositoryGitlabDTO, AzureDevOpsProject, AzureDevOpsProjectsResponse, GithubOrganization (+52 more)

### Community 33 - "Select & Environment Selector"
Cohesion: 0.09
Nodes (26): CreateBuildRequest, build(), initSentry(), start(), azureDataSchema, CodeRepository, CodeRepositoryProvider, codeRepositorySchema (+18 more)
...
Cohesion: 0.15
Nodes (12): AuthenticationError, getSecret(), AuthUserDTO, getDataFromAuth0(), getDataFromGoogle(), getDataFromLocal(), getDataFromMsal(), getEntraIdIssuer() (+4 more)
...
Cohesion: 0.08
Nodes (29): App(), queryClient, Auth0AuthWrapper(), Auth0AuthWrapperProps, GoogleAuthWrapper(), MicrosoftAuthWrapper(), MicrosoftAuthWrapperProps, GlobalParameterContext (+21 more)
...
Cohesion: 0.08
Nodes (37): cache, CacheEntry, NpmAbbreviatedPackument, NpmPackageInfo, NpmRegistryClient, DEPENDENCY_SECTIONS, ManifestFile, MicrofrontendDependencyService (+29 more)
...
Cohesion: 0.15
Nodes (15): telemetryController(), NODE_ENVS, logTelemetryNotice(), TelemetryService, TelemetryRuntimeConfiguration, TelemetryDecisionDTO, TelemetryPayloadDTO, TelemetryStatusDTO (+7 more)

### Community 50 - "User & Invitation API"
Cohesion: 0.10
Nodes (29): IMicrofrontendStack, FederationConfigRequest, FederationRemote, FRAMEWORK_PROFILES, FrameworkProfile, IntegrationInstructions, REQUIRED_DEV_DEPENDENCIES, FederationFileChangeDTO (+21 more)
...
Cohesion: 0.11
Nodes (24): createUrl(), doRequest(), getUTMFields(), IClientRequestData, IClientRequestMetadata, IUTMFields, out, removeUTMFields() (+16 more)
...
Cohesion: 0.09
Nodes (39): FormValues, LoginPage(), CalendarField(), CalendarFieldProps, LanguageSelector(), LanguageSelectorProps, ThemeToggle(), ThemeToggleProps (+31 more)
...
Cohesion: 0.15
Nodes (12): AuthTokenDataDTO, IUserDocument, User, userSchema, { logWarn }, NOON, fastify, FastifyContextConfig (+4 more)

### Community 66 - "IntegrationService.ts"
Cohesion: 0.14
Nodes (5): StartupController(), UserController(), UserAvatar, EmailSenderService, UserService
...
Cohesion: 0.17
Nodes (14): ICodeRepositoryMicrofrontend, CodeRepositoryImportService, FailedRepositoryResult, ImportableRepository, ImportedRepositoryResult, ImportRepositoriesResult, SkippedRepositoryResult, asId() (+6 more)
...
Cohesion: 0.13
Nodes (15): TextareaFieldProps, AzureAuthConfig, AzureStorageConfig, CreateStorageDTO, GoogleAuthConfig, GoogleStorageConfig, IStorageAuth, S3ClientConfig (+7 more)
...
Cohesion: 0.13
Nodes (13): AuthConfig, AzureStorageClient, AzureStorageConfig, AuthConfig, GoogleStorageConfig, S3ClientConfig, BuiltFrontend, builtFrontendSchema (+5 more)
...
Cohesion: 0.08
Nodes (30): AuthenticationLayout(), AuthenticationLayoutProps, sizeClasses, TextFieldProps, MainLogo(), MainLogoProps, sizeClasses, PENDING_INVITATIONS_QUERY_KEY (+22 more)
...
Cohesion: 0.07
Nodes (39): Button(), ProjectPickerListProps, SwitchProjectButton(), AddUserToProjectDTO, Project, ProjectSummaryDTO, RoleInProject, useProjectApi() (+31 more)
...
Cohesion: 0.18
Nodes (15): AzureDevOpsBuild, GithubWorkflowRun, normalizeAzureStatus(), normalizeGithubStatus(), normalizeGitlabStatus(), shortenRef(), snapshotCache, toAzureRun() (+7 more)
...
Cohesion: 0.09
Nodes (24): AuthenticationType, DeleteConfirmationDialog(), DeleteConfirmationDialogProps, ApiKey, CreateApiKeyDTO, CreateApiKeyResponseDTO, useApiKeysApi(), ProjectUser (+16 more)
...
Cohesion: 0.32
Nodes (3): EnvironmentService, EnvironmentDTO, toObjectId()
...
Cohesion: 0.33
Nodes (4): IStorage, StorageService, StorageDTO, runInTransaction()

### Community 188 - "NpmRegistryClient.ts"
Cohesion: 0.39
Nodes (6): buildController(), openEventStream(), sendEvent(), sleep(), getByProjectId, snapshot

### Community 190 - "FrontendIntegration.tsx"
Cohesion: 0.20
...
Cohesion: 0.36
Nodes (4): BuildStatusService, CachedSnapshot, MicrofrontendBuildStatusDTO, ProjectBuildStatusDTO
...
### Community 194 - "Local Installation for development 🛠️"
Cohesion: 0.40
...
### Community 207 - "DeploymentCanaryUsersController.ts"
Cohesion: 0.18
...
- **Why does `useUserApi()` connect `useUserApi.ts` to `IntegrationService.ts`, `Auth Pages & Form Inputs`, `GitHub Client Types`, `NotFound Page`, `Error Handler Middleware`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `toObjectId()` connect `EmailSenderService` to `Deployment Service & Models`, `Backend Controllers & Auth`, `Cloud Storage & Project Controllers`, `UI Cards & Alerts`, `[2.3.0] - 2026-08-11`, `Microfrontend Pages & API`, `Dialogs & Color Picker`, `UI Inputs & Popover`, `Tables & Layout Components`, `Storage API Client`, `API Hooks & Pages`, `Code Repository Service`, `Select & Environment Selector`, `Canary Users Domain`, `Form Input Fields`, `User & Invitation API`, `errorHandler.ts`, `AzureStorageClient`, `BaseAuthorizedService`, `BuildStatusService`, `IntegrationService.ts`, `AuthenticationMethod.ts`, `DeploymentCanaryUsersController.ts`, `Switch Component`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `useApiClient()` connect `Auth Pages & Form Inputs` to `Login & Social Buttons`, `Backend Error Types`, `Form UI Component`, `toObjectId`, `GitHub Client Types`, `scripts`, `NotFound Page`, `BusinessException`, `Dependencies.tsx`, `Error Handler Middleware`, `Multipart Plugin`, `useUserApi.ts`, `Tabs Component`?**
