...
## Corpus Check
- 364 files · ~292,914 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3135 nodes · 5605 edges · 184 communities (148 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16390dc6`
...
3. `microfrontend` - 77 edges
4. `Button()` - 56 edges
5. `useToastNotificationStore` - 54 edges
6. `apiKeys` - 45 edges
7. `apiKeys` - 45 edges
...
Cohesion: 0.06
Nodes (25): authorizationController(), GoogleTokenResponse, configurationController(), StartupController(), StartupUserRegistrationDTO, UserController(), AuthenticationError, getSecret() (+17 more)

### Community 3 - "Backend Error Types"
Cohesion: 0.09
Nodes (29): integrationController(), AcceptInvitationDTO, AddUserToProjectDTO, PopulatedProject, UpdateUserRoleDTO, UserProjectWithProject, EntityNotFoundError, build() (+21 more)
...
Cohesion: 0.24
Nodes (6): CreateApiKeyDialogProps, ApiKeyFormData, CreateApiKeyFormInner(), CreateApiKeyFormProps, NoApiKeyPlaceholder(), NoApiKeyPlaceholderProps
...
Cohesion: 0.08
Nodes (36): configSchema, Configuration, IConfiguration, Deployment, deploymentSchema, Environment, environmentSchema, GlobalVariable (+28 more)

### Community 8 - "Auth Pages & Form Inputs"
Cohesion: 0.11
Nodes (23): AuthenticationLayout(), AuthenticationLayoutProps, sizeClasses, TextFieldProps, MainLogo(), MainLogoProps, sizeClasses, useUserApi() (+15 more)

### Community 9 - "Code Repositories UI"
Cohesion: 0.04
Nodes (70): GitHub Code Repository Provider, GitHub Logo (Octocat Mark), TextareaFieldProps, AddRepositoryAzureDTO, AddRepositoryGithubDTO, AddRepositoryGitlabDTO, AzureDevOpsProject, AzureDevOpsProjectsResponse (+62 more)
...
Cohesion: 0.11
Nodes (21): apiKeyController(), codeRepositoryController(), environmentController(), globalVariablesController(), microfrontendController(), microfrontendDependencyController(), projectStateWizardController(), projectUserController() (+13 more)
...
Cohesion: 0.09
Nodes (19): EnvironmentSelectorProps, EnvironmentDTO, GlobalVariableCreateDTO, moveItem(), useDragAndDropOrder(), UseDragAndDropOrderProps, EnvironmentVariableDialogProps, EnvironmentValue (+11 more)
...
Cohesion: 0.10
Nodes (11): deploymentController(), IDeployment, IEnvironment, IGlobalVariable, DeploymentService, EnvironmentService, GlobalVariablesService, GetAllDataDTO (+3 more)
...
Cohesion: 0.08
Nodes (31): CanaryDeploymentType, CanaryType, DimensionsDTO, HostedOn, Microfrontend, PositionDTO, RelationDTO, MicrofrontendSelector() (+23 more)
...
Cohesion: 0.10
Nodes (31): Auth0AuthWrapper(), Auth0AuthWrapperProps, FormValues, LoginComponentProps, LoginPage(), LoginWithAuth0Button(), LoginWithGoogleButton(), LoginWithMicrosoftButton() (+23 more)
...
Cohesion: 0.09
Nodes (35): ApiStatusHandler(), SinglePageHeaderProps, DeleteConfirmationDialog(), DeleteConfirmationDialogProps, useApiKeysApi(), CanaryUser, useCanaryUsersApi(), CanaryUser (+27 more)
...
Cohesion: 0.10
Nodes (30): App(), queryClient, CalendarField(), CalendarFieldProps, LanguageSelector(), LanguageSelectorProps, ThemeToggle(), ThemeToggleProps (+22 more)
...
Cohesion: 0.06
Nodes (38): Button(), ProjectPickerListProps, SwitchProjectButton(), AddUserToProjectDTO, Project, ProjectSummaryDTO, useProjectApi(), AddRepositoryDialog() (+30 more)
...
Cohesion: 0.08
Nodes (8): adm-zip, GoogleStorageClient, S3BucketClient, IMarket, IMicrofrontend, IntegrationService, MarketService, MicrofrontendService
...
Cohesion: 0.06
Nodes (38): AuthenticationType, createUrl(), doRequest(), getUTMFields(), IClientRequestData, IClientRequestMetadata, IUTMFields, out (+30 more)
...
Cohesion: 0.16
Nodes (15): PENDING_INVITATIONS_QUERY_KEY, PendingInvitationsList(), PendingInvitationsListProps, usePendingInvitationsQuery(), ProjectPickerList(), SinglePageLayout(), AcceptInvitationDTO, AcceptInvitationResponse (+7 more)
...
Cohesion: 0.08
Nodes (58): activateAccountFromEmail(), AppSession, canSendEmail(), CreatedProject, createProjectViaApi(), emailDeliveryUnavailable(), expectLoginPage(), getMineProjectsViaApi() (+50 more)
...
Cohesion: 0.10
Nodes (20): environment, color, color_tooltip, configure, create_success, created_success_message, custom_environments, delete_title (+12 more)
...
## Knowledge Gaps
- **1677 isolated node(s):** `description`, `main`, `start`, `st`, `dev` (+1672 more)
...
- **Why does `useUserApi()` connect `Auth Pages & Form Inputs` to `Backend Controllers & Auth`, `biome.json`, `Google & S3 Storage Clients`, `Auth Wrappers & Context`, `Tabs Component`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `toObjectId()` connect `Backend Controller Layer` to `Login & Social Buttons`, `Deployment Service & Models`, `Backend Controllers & Auth`, `Form UI Component`, `Backend Error Types`, `Cloud Storage & Project Controllers`, `Azure Storage & Microfrontend Model`, `Microfrontend Pages & API`, `Canary Users Domain`, `Project Users & Invitations`, `Form Input Fields`, `Dialogs & Color Picker`, `Biome Complexity Rules`, `Tables & Layout Components`, `CodeRepositoryController.ts`, `Project Wizard Service`, `API Key Domain`, `Code Repository Service`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `UserButton()` connect `Auth Wrappers & Context` to `Frontend Routes`, `React Misc Hooks`, `Google & S3 Storage Clients`?**
