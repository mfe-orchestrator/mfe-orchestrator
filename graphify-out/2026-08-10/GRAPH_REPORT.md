# Graph Report - mfe-orchestrator  (2026-08-10)

## Corpus Check
- 357 files · ~286,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3081 nodes · 5411 edges · 201 communities (162 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b09ccd51`
...
Cohesion: 0.15
Nodes (14): AcceptInvitationDTO, AddUserToProjectDTO, PopulatedProject, projectUserController(), UpdateUserRoleDTO, UserProjectWithProject, ProjectHeaderNotFoundError, IUserProject (+6 more)

### Community 4 - "Cloud Storage & Project Controllers"
Cohesion: 0.09
Nodes (34): EntityNotFoundError, configSchema, Configuration, IConfiguration, Deployment, deploymentSchema, DeploymentToCanaryUsers, deploymentToCanaryUsersSchema (+26 more)

### Community 5 - "UI Cards & Alerts"
Cohesion: 0.06
Nodes (41): GitHub Code Repository Provider, GitHub Logo (Octocat Mark), DeleteConfirmationDialog(), DeleteConfirmationDialogProps, AddRepositoryAzureDTO, AddRepositoryGithubDTO, AddRepositoryGitlabDTO, AzureDevOpsProject (+33 more)
...
Cohesion: 0.09
Nodes (24): AuthConfig, AzureStorageClient, AzureStorageConfig, AuthConfig, GoogleStorageConfig, S3ClientConfig, build(), fastify (+16 more)

### Community 8 - "Auth Pages & Form Inputs"
Cohesion: 0.12
Nodes (18): AddUserToProjectDTO, ProjectSummaryDTO, RoleInProject, NewProjectWizard(), NewProjectWizardProps, MainData(), MainDataForm, slugify() (+10 more)

### Community 9 - "Code Repositories UI"
Cohesion: 0.07
Nodes (41): CanaryDeploymentType, CanaryType, DimensionsDTO, HostedOn, Microfrontend, PositionDTO, RelationDTO, useMicrofrontendsApi() (+33 more)
...
Cohesion: 0.10
Nodes (34): NpmPackageInfo, CodeRepositoryProvider, DEPENDENCY_SECTIONS, ManifestFile, ManifestSnapshot, PackageManifest, SECTION_BY_KIND, CodeRepositoryCreateDTO (+26 more)

### Community 17 - "UI Inputs & Popover"
Cohesion: 0.26
Nodes (11): ProjectPickerListProps, SwitchProjectButton(), Project, useProjectApi(), ProjectState, SelectProjectForm(), SelectProjectFormProps, SelectProjectWrapper() (+3 more)

### Community 18 - "Frontend Routes"
Cohesion: 0.05
Nodes (32): EXTERNAL_NAV_ITEMS, Sidebar, SidebarProps, AccountActivation, AddAzure, AddGithub, AddGitlab, AddMicrofrontend (+24 more)

### Community 19 - "Backend Controller Layer"
Cohesion: 0.10
Nodes (20): apiKeyController(), codeRepositoryController(), environmentController(), globalVariablesController(), integrationController(), microfrontendController(), microfrontendDependencyController(), projectController() (+12 more)
...
Cohesion: 0.07
Nodes (33): AuthenticationLayout(), AuthenticationLayoutProps, sizeClasses, TextFieldProps, MainLogo(), MainLogoProps, sizeClasses, EnvironmentValue (+25 more)
...
Cohesion: 0.09
Nodes (30): ApiStatusHandler(), useApiKeysApi(), CanaryUser, useCanaryUsersApi(), CanaryUser, DeploymentDTO, useDeploymentsApi(), GlobalVariable (+22 more)
...
Cohesion: 0.12
Nodes (10): cn(), DangerZone(), DangerZoneProps, InfoItemProps, ProjectInfoSection(), ProjectInfoSectionProps, ProjectStatsSection(), ProjectStatsSectionProps (+2 more)
...
Cohesion: 0.12
Nodes (4): ICodeRepository, CodeRepositoryService, RepositoryTarget, CreateGitlabRepositoryDto
...
Cohesion: 0.22
Nodes (5): createBusinessException(), mapWithConcurrency(), MicrofrontendDependencyService, toErrorMessage(), MicrofrontendAlignmentChangeDTO

### Community 36 - "Google & S3 Storage Clients"
Cohesion: 0.11
Nodes (31): App(), queryClient, FormValues, LoginPage(), LanguageSelector(), LanguageSelectorProps, ThemeToggle(), ThemeToggleProps (+23 more)
...
Cohesion: 0.11
Nodes (21): TextareaFieldProps, EnvironmentSelectorProps, CreateEnvironmentDTO, EnvironmentDTO, useEnvironmentsApi(), moveItem(), useDragAndDropOrder(), UseDragAndDropOrderProps (+13 more)
...
Cohesion: 0.35
Nodes (6): AuthTokenDataDTO, IUserDocument, User, userSchema, UserStatus, IAcceptInvitationData
...
Cohesion: 0.10
Nodes (21): LoginComponentProps, LoginWithAuth0Button(), LoginWithGoogleButton(), LoginWithMicrosoftButton(), SocialLoginRow(), SocialLoginRowProps, getAccessToken(), GoogleTokenResponse (+13 more)
...
Cohesion: 0.31
Nodes (3): IProject, ProjectService, ProjectSummaryDTO

### Community 56 - "Microfrontend Service"
Cohesion: 0.09
Nodes (6): adm-zip, GoogleStorageClient, S3BucketClient, IMicrofrontend, IntegrationService, MicrofrontendService
...
Cohesion: 0.25
Nodes (6): CalendarField(), CalendarFieldProps, CreateApiKeyDialogProps, ApiKeyFormData, CreateApiKeyFormInner(), CreateApiKeyFormProps
...
Cohesion: 0.12
Nodes (16): CI/CD, Configuration, Debug tests, Documentation, E2E Tests with Playwright, Generate tests with Codegen, Installation, Prerequisites (+8 more)
...
Cohesion: 0.11
Nodes (24): SinglePageHeaderProps, AzureAuthConfig, AzureStorageConfig, CreateStorageDTO, GoogleAuthConfig, GoogleStorageConfig, IStorageAuth, S3ClientConfig (+16 more)
...
Cohesion: 0.39
Nodes (5): ProjectPickerList(), SinglePageLayout(), AddNewMicrofrontendCard(), AddNewMicrofrontendCardProps, cn()
...
Cohesion: 0.13
Nodes (32): activateAccountFromEmail(), AppSession, canSendEmail(), CreatedProject, createProjectViaApi(), inviteCollaboratorViaUi(), loginViaApi(), loginViaUi() (+24 more)
...
Cohesion: 0.13
Nodes (15): redeploy, view_canary_users, deployments, actions, active_deployments, deploy_button, env_variables_title, environment_select (+7 more)
...
Cohesion: 0.14
Nodes (14): CreateBuildRequest, azureDataSchema, codeRepositorySchema, CodeRepositoryType, githubDataSchema, gitlabDataSchema, IAzureData, IGithubData (+6 more)
...
## Knowledge Gaps
- **1662 isolated node(s):** `description`, `main`, `start`, `st`, `dev` (+1657 more)
...
- **Why does `useUserApi()` connect `Google & S3 Storage Clients` to `Backend Controllers & Auth`, `Form Input Fields`, `Sidebar & Theme Toggle`, `Auth Wrappers & Context`, `Tabs Component`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `toObjectId()` connect `Microfrontend Pages & API` to `Deployment Service & Models`, `Login & Social Buttons`, `Backend Controllers & Auth`, `Backend Error Types`, `Cloud Storage & Project Controllers`, `Dropdown Menu & Sidebar`, `Scopes (Optional)`, `Azure Storage & Microfrontend Model`, `FrontendIntegration.tsx`, `Canary Users Domain`, `Project Users & Invitations`, `Dialogs & Color Picker`, `Backend Controller Layer`, `Code Management Service`, `Microfrontend Service`, `Project Wizard Service`, `API Key Domain`, `Code Repository Service`?**
