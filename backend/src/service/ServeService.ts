...
export default class ServeService {
     ...
     */
    async getByEnvironmentSlugAndProjectIdAndMicrofrontendSlug(
        environmentSlug: string,
        projectId: string,
        microfrontendSlug: string
    ): Promise<IMicrofrontend | null> {
     ...
     * @returns Promise with Microfrontend object or null if not found
     */
    async getMicrofrontendByProjectIdAndEnvironmentSlug(
        projectId: string,
        environmentSlug: string
    ): Promise<IMicrofrontend | null> {
        // TODO: Implement database query to fetch by project ID and environment slug
     ...
     * @returns Promise with global variables object
     */
    async getGlobalVariablesByProjectIdAndEnvironmentSlug(
        projectId: string,
        environmentSlug: string
...
const getMicrofrontendUrlCanaryOrStatic = async (microfrontend: IMicrofrontend, deployment?: IDeployment, userId?: string): Promise<string> =>{
    ...
    }else if(microfrontend.canary?.type === CanaryType.ON_USER){ //TODO questo va rivisto tutto(!)
